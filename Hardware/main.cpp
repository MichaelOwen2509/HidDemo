...
void ReadAnswerMode(void)
{
	...
	if (CFHid_InventoryG2(0xFF,arrBuffer,&iTagLength,&iTagNumber) == FALSE)
	{
		//cout<<"Failed"<<endl;
		return;
	}
...
int main()
{
    ...
    switch(key)
    {
        case 0://readRFPower
                ...
                07: UartBaudRate*/
            bParamAddr = 0x05;
            if (CFHid_ReadDeviceOneParam(0xFF,bParamAddr, &bValue) == FALSE)
            {
                cout<<"Failed"<<endl;
                return 0;
            }
        ...
        case 1: //SetRF
            ...
            break;
        case 2://WriteTag
            if (CFHid_WriteCardG2(0xFF,Password,Mem,WordPtr,WriteLen,Writedata) == FALSE)
            {
                cout<<"Failed"<<endl;
                return 0;
            }
